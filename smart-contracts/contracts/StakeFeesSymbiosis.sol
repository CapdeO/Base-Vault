...
/*
Deployed and verified at: https://symbiosis.calderaexplorer.xyz/address/0x46D3F465E227f75a6CD03aB5c5782d1581BBfdCC?tab=index
*/
...
interface ISymbiosis {
    ...
    function withdraw(
        uint256 amount,          // Monto a retirar
        uint256 shares,         // Acciones a retirar
        uint256 minAsetsToReceive, // Mínimo de activos a recibir
        address recipient,       // Dirección del destinatario
        uint256 deadline         // Fecha límite para la transacción
...
contract StakeFees is ERC4626, Ownable {
    ...
    ISymbiosis public immutable pool; // = IAavePool(0xA238Dd80C259a72e81d7e4664a9801593F98d1c5);
    IERC20 public immutable usdc = IERC20(0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913); // USDC address
    IERC20 public constant aUsdc = IERC20(0xC3255E317481B95A3e61844c274dE8BAF8eDF397); // aUSDC address
    ...
    constructor() ERC4626(aUsdc) Ownable(msg.sender) {
        protocolAddr = tx.origin;
        minStakingTime = 60;
        fee_ = 20; // 0.2% al salir

        pool = ISymbiosis(0xC3255E317481B95A3e61844c274dE8BAF8eDF397);
        usdc = IERC20(0xFBe80e8C3FbFf0bC314b33d1C6185230aC319309); // USDC address
    ...
    function deposit(uint256 assets, address receiver, uint256 target) public virtual onlyOwner returns (uint256) {
    ...
    function _withdrawAve(
        ...
        uint256 withdrawnAmount = pool.withdraw(15, amount, 0, msg.sender, (block.timestamp+3600) );
